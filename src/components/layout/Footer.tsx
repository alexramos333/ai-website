    ...
    <footer className="mt-auto">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-6 py-12 sm:grid-cols-2 md:grid-cols-3">
        ...
        <div>
          ...
          <address className="mt-4 space-y-3 not-italic text-white">
            <p className="flex items-center gap-2">
              ...
              <a href="tel:9106199205" className="transition-colors hover:text-[#5de6fc]">
                910-619-9205
              </a>
            </p>
            <p className="flex items-center gap-2">
              ...
              <a href="mailto:alexramos300@gmail.com" className="transition-colors hover:text-[#5de6fc]">
        ...
        <div>
          ...
          <div className="mt-4 flex flex-col gap-2">
            <a
              ...
              className="text-white transition-colors hover:text-[#5de6fc]"
            >
              LinkedIn
            </a>
            <a
              href="https://github.com/alexramos333"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white transition-colors hover:text-[#5de6fc]"
            >
